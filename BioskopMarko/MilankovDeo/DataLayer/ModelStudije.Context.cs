...
namespace MilankovDeo.DataLayer
{
    ...
    public partial class aspLab2015Entities : DbContext
    {
        public aspLab2015Entities()
            : base("name=aspLab2015Entities")
        {
        ...
        public DbSet<Filmovi> Filmovis { get; set; }
        public DbSet<Bioskopi> Bioskopis { get; set; }
        public DbSet<Zanrovi> Zanrovis { get; set; }
        public DbSet<Poruke> Porukes { get; set; }
        public DbSet<StranaKontakt> StranaKontakts { get; set; }
        ...
        public virtual ObjectResult<SelectKorisnikDodatno_Result> SelectKorisnikDodatno(Nullable<System.Guid> userId)
        {
            var userIdParameter = userId.HasValue ?
                new ObjectParameter("UserId", userId) :
                new ObjectParameter("UserId", typeof(System.Guid));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectKorisnikDodatno_Result>("SelectKorisnikDodatno", userIdParameter);
        }
        ...
        public virtual ObjectResult<SelectFilmoviWhereId_Result> SelectFilmoviWhereId(Nullable<int> idFilma)
        {
            var idFilmaParameter = idFilma.HasValue ?
                new ObjectParameter("idFilma", idFilma) :
                new ObjectParameter("idFilma", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SelectFilmoviWhereId_Result>("SelectFilmoviWhereId", idFilmaParameter);
        }
    
        public virtual int FilmoviUpdate(Nullable<int> idFilma, string nazivFilma, Nullable<int> idBioskopa, string opisFilma, Nullable<int> ocena, Nullable<System.DateTime> datumPostavljanja, string putanjaDoSlike, string zanrovi, string korisnik)
        {
            var idFilmaParameter = idFilma.HasValue ?
                new ObjectParameter("idFilma", idFilma) :
                new ObjectParameter("idFilma", typeof(int));
    
            var nazivFilmaParameter = nazivFilma != null ?
                new ObjectParameter("NazivFilma", nazivFilma) :
                new ObjectParameter("NazivFilma", typeof(string));
    
            var idBioskopaParameter = idBioskopa.HasValue ?
                new ObjectParameter("idBioskopa", idBioskopa) :
                new ObjectParameter("idBioskopa", typeof(int));
    
            var opisFilmaParameter = opisFilma != null ?
                new ObjectParameter("opisFilma", opisFilma) :
                new ObjectParameter("opisFilma", typeof(string));
    
            var ocenaParameter = ocena.HasValue ?
                new ObjectParameter("ocena", ocena) :
                new ObjectParameter("ocena", typeof(int));
    
            var datumPostavljanjaParameter = datumPostavljanja.HasValue ?
                new ObjectParameter("datumPostavljanja", datumPostavljanja) :
                new ObjectParameter("datumPostavljanja", typeof(System.DateTime));
    
            var putanjaDoSlikeParameter = putanjaDoSlike != null ?
                new ObjectParameter("putanjaDoSlike", putanjaDoSlike) :
                new ObjectParameter("putanjaDoSlike", typeof(string));
    
            var zanroviParameter = zanrovi != null ?
                new ObjectParameter("zanrovi", zanrovi) :
                new ObjectParameter("zanrovi", typeof(string));
    
            var korisnikParameter = korisnik != null ?
                new ObjectParameter("Korisnik", korisnik) :
                new ObjectParameter("Korisnik", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FilmoviUpdate", idFilmaParameter, nazivFilmaParameter, idBioskopaParameter, opisFilmaParameter, ocenaParameter, datumPostavljanjaParameter, putanjaDoSlikeParameter, zanroviParameter, korisnikParameter);
        }
    
        public virtual int FilmoviDelete(Nullable<int> idFilma)
        {
            var idFilmaParameter = idFilma.HasValue ?
                new ObjectParameter("idFilma", idFilma) :
                new ObjectParameter("idFilma", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FilmoviDelete", idFilmaParameter);
        }
    
        public virtual int FilmoviInsert(string nazivFilma, Nullable<int> idBioskopa, string opisFilma, Nullable<int> ocena, Nullable<System.DateTime> datumPostavljanja, string putanjaDoSlike, string zanr, string korisnik)
        {
            var nazivFilmaParameter = nazivFilma != null ?
                new ObjectParameter("NazivFilma", nazivFilma) :
                new ObjectParameter("NazivFilma", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("FilmoviInsert", nazivFilmaParameter, idBioskopaParameter, opisFilmaParameter, ocenaParameter, datumPostavljanjaParameter, putanjaDoSlikeParameter, zanrParameter, korisnikParameter);
        }
    
        public virtual int PorukeInsert(string naslovPoruke, string opisPoruke, string emailKlijenta)
        {
            var naslovPorukeParameter = naslovPoruke != null ?
                new ObjectParameter("NaslovPoruke", naslovPoruke) :
                new ObjectParameter("NaslovPoruke", typeof(string));
    
            var opisPorukeParameter = opisPoruke != null ?
                new ObjectParameter("OpisPoruke", opisPoruke) :
                new ObjectParameter("OpisPoruke", typeof(string));
    
            var emailKlijentaParameter = emailKlijenta != null ?
                new ObjectParameter("emailKlijenta", emailKlijenta) :
                new ObjectParameter("emailKlijenta", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("PorukeInsert", naslovPorukeParameter, opisPorukeParameter, emailKlijentaParameter);
        }
    
        public virtual int SlikeDelete(Nullable<int> idSlike)
        {
            var idSlikeParameter = idSlike.HasValue ?
                new ObjectParameter("idSlike", idSlike) :
                new ObjectParameter("idSlike", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SlikeDelete", idSlikeParameter);
        }
    
        public virtual ObjectResult<SlikeStranicenje_Result> SlikeStranicenje(Nullable<int> lIMIT, Nullable<int> oFFSET, Nullable<int> idGalerije, ObjectParameter ukupanBrojSlika)
        {
            ...
            var idGalerijeParameter = idGalerije.HasValue ?
                new ObjectParameter("idGalerije", idGalerije) :
                new ObjectParameter("idGalerije", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SlikeStranicenje_Result>("SlikeStranicenje", lIMITParameter, oFFSETParameter, idGalerijeParameter, ukupanBrojSlika);
        }
    
        public virtual int SlikeUpdate(Nullable<int> idSlike, string nazivSlike, string putanjaDoSlike, Nullable<int> idGalerije, string korisnik, Nullable<System.DateTime> datumIzmene)
        {
            var idSlikeParameter = idSlike.HasValue ?
                new ObjectParameter("IdSlike", idSlike) :
                new ObjectParameter("IdSlike", typeof(int));
    
            var nazivSlikeParameter = nazivSlike != null ?
                new ObjectParameter("NazivSlike", nazivSlike) :
                new ObjectParameter("NazivSlike", typeof(string));
            ...
            var datumIzmeneParameter = datumIzmene.HasValue ?
                new ObjectParameter("DatumIzmene", datumIzmene) :
                new ObjectParameter("DatumIzmene", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SlikeUpdate", idSlikeParameter, nazivSlikeParameter, putanjaDoSlikeParameter, idGalerijeParameter, korisnikParameter, datumIzmeneParameter);
        }
    
        public virtual int SlikeInsert(string nazivSlike, string putanjaDoSlike, Nullable<int> idGalerije, Nullable<System.DateTime> datumPostavljanja, string korisnik, Nullable<System.DateTime> datumIzmene)
        {
            var nazivSlikeParameter = nazivSlike != null ?
                new ObjectParameter("NazivSlike", nazivSlike) :
                new ObjectParameter("NazivSlike", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("SlikeInsert", nazivSlikeParameter, putanjaDoSlikeParameter, idGalerijeParameter, datumPostavljanjaParameter, korisnikParameter, datumIzmeneParameter);
        }
    
        public virtual int GalerijaUpdate(Nullable<int> idGalerije, string nazivGalerije, string putanjaDoSlike, string korisnik, Nullable<System.DateTime> datumIzmene)
        {
            var idGalerijeParameter = idGalerije.HasValue ?
                new ObjectParameter("IdGalerije", idGalerije) :
                new ObjectParameter("IdGalerije", typeof(int));
    
            var nazivGalerijeParameter = nazivGalerije != null ?
                new ObjectParameter("NazivGalerije", nazivGalerije) :
                new ObjectParameter("NazivGalerije", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GalerijaUpdate", idGalerijeParameter, nazivGalerijeParameter, putanjaDoSlikeParameter, korisnikParameter, datumIzmeneParameter);
        }
    
        public virtual int GalerijaInsert(string nazivGalerije, string putanjaDoSlike, string korisnik, Nullable<System.DateTime> datumPostavljanja, Nullable<System.DateTime> datumIzmene)
        {
            var nazivGalerijeParameter = nazivGalerije != null ?
                new ObjectParameter("NazivGalerije", nazivGalerije) :
                new ObjectParameter("NazivGalerije", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GalerijaInsert", nazivGalerijeParameter, putanjaDoSlikeParameter, korisnikParameter, datumPostavljanjaParameter, datumIzmeneParameter);
        }
    
        public virtual int GalerijaDelete(Nullable<int> idGalerije)
        {
            var idGalerijeParameter = idGalerije.HasValue ?
                new ObjectParameter("IdGalerije", idGalerije) :
                new ObjectParameter("IdGalerije", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("GalerijaDelete", idGalerijeParameter);
        }
    
        public virtual int StranaKontaktUpdate(Nullable<int> idStranaKontakt, string nazivStraneKontakt, string naslovStraneKontakt, string tekstStraneKontakt, string bioskopi, string korisnik, Nullable<System.DateTime> datumIzmene)
        {
            var idStranaKontaktParameter = idStranaKontakt.HasValue ?
                new ObjectParameter("IdStranaKontakt", idStranaKontakt) :
                new ObjectParameter("IdStranaKontakt", typeof(int));
    
            var nazivStraneKontaktParameter = nazivStraneKontakt != null ?
                new ObjectParameter("NazivStraneKontakt", nazivStraneKontakt) :
                new ObjectParameter("NazivStraneKontakt", typeof(string));
    
            var naslovStraneKontaktParameter = naslovStraneKontakt != null ?
                new ObjectParameter("NaslovStraneKontakt", naslovStraneKontakt) :
                new ObjectParameter("NaslovStraneKontakt", typeof(string));
    
            var tekstStraneKontaktParameter = tekstStraneKontakt != null ?
                new ObjectParameter("TekstStraneKontakt", tekstStraneKontakt) :
                new ObjectParameter("TekstStraneKontakt", typeof(string));
    
            var bioskopiParameter = bioskopi != null ?
                new ObjectParameter("Bioskopi", bioskopi) :
                new ObjectParameter("Bioskopi", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("StranaKontaktUpdate", idStranaKontaktParameter, nazivStraneKontaktParameter, naslovStraneKontaktParameter, tekstStraneKontaktParameter, bioskopiParameter, korisnikParameter, datumIzmeneParameter);
        }
    
        public virtual int AnketaDelete(Nullable<int> idAnkete)
        {
            var idAnketeParameter = idAnkete.HasValue ?
                new ObjectParameter("idAnkete", idAnkete) :
                new ObjectParameter("idAnkete", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AnketaDelete", idAnketeParameter);
        }
    
        public virtual int AnketaGlasanje(Nullable<int> idAnkete, Nullable<int> idStavke)
        {
            var idAnketeParameter = idAnkete.HasValue ?
                new ObjectParameter("idAnkete", idAnkete) :
                new ObjectParameter("idAnkete", typeof(int));
    
            var idStavkeParameter = idStavke.HasValue ?
                new ObjectParameter("idStavke", idStavke) :
                new ObjectParameter("idStavke", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AnketaGlasanje", idAnketeParameter, idStavkeParameter);
        }
    
        public virtual int AnketaInsert(string naziv)
        {
            var nazivParameter = naziv != null ?
                new ObjectParameter("naziv", naziv) :
                new ObjectParameter("naziv", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AnketaInsert", nazivParameter);
        }
    
        public virtual int AnketaUpdate(Nullable<int> idAnkete, string naziv)
        {
            var idAnketeParameter = idAnkete.HasValue ?
                new ObjectParameter("idAnkete", idAnkete) :
                new ObjectParameter("idAnkete", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("AnketaUpdate", idAnketeParameter, nazivParameter);
        }
    
        public virtual int StavkeDelete(Nullable<int> idAnkete, Nullable<int> idStavke)
        {
            var idAnketeParameter = idAnkete.HasValue ?
                new ObjectParameter("idAnkete", idAnkete) :
                new ObjectParameter("idAnkete", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("StavkeDelete", idAnketeParameter, idStavkeParameter);
        }
    
        public virtual int StavkeInsert(Nullable<int> idAnkete, string odgovor)
        {
            var idAnketeParameter = idAnkete.HasValue ?
                new ObjectParameter("idAnkete", idAnkete) :
                new ObjectParameter("idAnkete", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("StavkeInsert", idAnketeParameter, odgovorParameter);
        }
    
        public virtual int StavkeUpdate(Nullable<int> idAnkete, Nullable<int> idStavke, string odgovor, string brojGlasova)
        {
            var idAnketeParameter = idAnkete.HasValue ?
                new ObjectParameter("idAnkete", idAnkete) :
                new ObjectParameter("idAnkete", typeof(int));
            ...
            var brojGlasovaParameter = brojGlasova != null ?
                new ObjectParameter("brojGlasova", brojGlasova) :
                new ObjectParameter("brojGlasova", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("StavkeUpdate", idAnketeParameter, idStavkeParameter, odgovorParameter, brojGlasovaParameter);
        }
    }
}
