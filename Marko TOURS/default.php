...
<html>
    <head>
        <title>Dobrodošli na <? print $host; ?>!</title>
    ...
    <body>
        <div id="main">
            <div id="content">
                <div class="header">
                    <a id="logo" href="http://www.hostinger.hr/"><img src="http://www.main-hosting.com/hostinger/welcome/images/logo.png" alt="Web hosting" /></a>
                </div>
                <div class="content">
                    <h1>Vaš račun je uspješno napravljen!</h1>
                    <p>Webstranica <b><? print $host; ?></b> je uspješno instalirana na server! Molimo vas da obrišete datoteku <b>default.php</b> iz public_html foldera i zatim učitajte vašu web stranicu koristeći FTP ili File Manager.</p>
                    <p>Ovdje je lista datoteka u vašem public_html folderu:/p>
                    <div id="files">
                        <div class="top"></div>
                        <div class="cont">
            ...
            <div id="footer">
                <div class="links">
                    <a href="http://www.hostinger.hr/web-hosting" target="_blank">Web Hosting</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.hr/besplatni-hosting" target="_blank">Besplatni hosting</a> 
                    <span class="pipe">|</span> 
                    <a href="http://www.hostinger.hr/forum" target="_blank">Forum</a> 
                    <span class="pipe">|</span> 
                    <a href="http://cpanel.hostinger.hr/" target="_blank">Client Login</a>
                </div>
                <div class="copyright">Hostinger Hrvatska &copy; <? print date('Y'); ?>.  Sva prava zadržana.</div>
                <div class="social-icons">
                    <a href="http://www.facebook.com/Hostinger.hr"><img src="http://www.main-hosting.com/hostinger/welcome/images/fb.gif" /></a>
